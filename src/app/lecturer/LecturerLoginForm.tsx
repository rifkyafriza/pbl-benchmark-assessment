...
export default function LecturerLogin() {
  ...
  return (
    <div className="min-h-screen bg-gray-50/50 dark:bg-gray-900/50 flex flex-col justify-center items-center p-4 relative overflow-hidden">
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] bg-orange/5 dark:bg-orange/10 rounded-full blur-3xl -z-10 pointer-events-none"></div>
